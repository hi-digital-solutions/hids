...
We tried a few different methods of resume reviews, but the most valuable change was opening up the pipeline to everyone on the team.  This gave anyone the opportunity to champion a candidate, and move them forward through the hiring process.  One of the themes that came up over and over again, was that having different perspectives makes for a better hiring process, and that includes resumé reviews as well.
...
As much as possible, we wanted hiring decisions to be made as close to the work as possible.  While we all participated in the interview process, if we knew that a candidate would be working with specific people, we tried to make sure they were involved.  In cases where we had to make a decision between multiple good candidates, the final decision was made by the folks who would be working with them every day.
...
Starting with those things in mind, we could identify some target conditions for this round of hiring.  It was easy to come up with a lot of goals for our organization; again, we used techniques from our daily work to "[story map](https://www.jpattonassociates.com/user-story-mapping/)" a list of objectives, and then prioritize them.  Ultimately , we decided to focus on three goals for this round:  Hiring at least one “senior” engineer, at least one “junior” engineer, and maintaining our gender balance at 50%, plus or minus one person.

### Experiments

Once we had identified our top priorities, we discussed what we could do to achieve them.  We felt that our biggest challenge would be attracting underrepresented candidates and folks early in their career, so we focused our efforts on three strategies:  Writing an inclusive job posting, committing to interview equal numbers of women and men, and making sure the interviews themselves were a positive experience for the folks we were hoping to hire.  

## Our Initial Hypotheses

### Job Posting

Based on our goals and our experience with tech demographics, we knew that we were targeting people who might feel apprehensive about applying.  Because of this, we really tried to make sure that our [job posting](https://www.hidigital.solutions/careers/) was inclusive and encouraging.  The entire team gave their input on the posting, and the phrase that we kept using was "let’s write a job post that we would respond to ourselves." 

### Interviewing Underrepresented Candidates

We put a lot of thought and did a lot of reading about the best way to reach the candidates we wanted--in this case, women.  Martin Fowler’s great [article](https://martinfowler.com/bliki/DiversityMediocrityIllusion.html) was especially influential; as he points out, it’s possible to build as diverse a team as you like, regardless of the distribution in your candidate pool--it may just take more time.

One of the things we discussed right from the beginning, was the willingness  to be patient; especially for a company as small as us, finding the right people was much more important than filling positions quickly.  We weren’t in a hurry, and so we decided to interview in cohorts, with approximately equal numbers of men and women.

In practice, that meant leaving our job posting up for a long time, looking at a lot of resumés, and waiting until our top six or eight candidates were evenly split between men and women.  We very quickly found enough male candidates that met our criteria; it took much longer for qualified women to apply, and by that time, the list of men had generally changed a couple of times.  We undoubtedly missed out on some good candidates who weren’t willing to wait, but we had so many responses that we were confident we would find a good fit.  

### Structuring Interviews

The last thing that we experimented with was how we structured our interviews; we wanted them to be low-pressure, encouraging, and personable, and we hoped that candidates would have a positive experience regardless of the outcome!

We tried several different approaches to help make our interview process less stressful for our candidates.  First, we emphasized that interview questions are a tool to help us learn about each other, not a gate or "gotcha."  Rather than tricky code challenges or whiteboard algorithms, we opted for discussions and dialog around architectural and delivery principles, along with collaborative coding exercises in a mob.

We also wanted to make sure candidates were comfortable with their interviewers.  As candidates moved through the stages of the interview, they had a designated "guide," a single person who was with them through the entire process.  We also tried to give all our candidates a chance to talk to someone on the team in a similar position; we wanted female candidates to be able to talk with other women on our team, and to give everyone the opportunity to discuss the job with someone who was working at a similar level.

Overall we felt good about our goals and approaches, but we also recognized that they were a starting point.  As we talked with more candidates, we got a better feel for what was working and what wasn’t, and made changes to our process as we learned.

## Iterating on the Hiring Process

Since we were approaching our hiring process the same way we would product work, we knew from the start that we wanted to take an iterative approach, and test along the way.  We weren’t sure what that would look like, but we had a few ideas that we could get started with.    
...
To do this, we interviewed candidates as normal, and recorded our thoughts as we usually would.  But rather than using any particular phase as a decision point, we promoted every candidate in the cohort through every phase of the process--even if we felt a session didn't go well, we would move the candidate forward, to make sure we weren't missing something.  
...
After several months, we had made some fantastic hires, and accomplished our three goals.  And while we were very happy with the folks joining our team, we also recognized some opportunities to improve our hiring process further.  We did meet our goal of keeping gender balance around 50%, but we ended up with a slightly *less* balanced team--going from 50--50 to 40--60, and three quarters of our new hires were men.   With a small team we expect the percentages to fluctuate a bit, and we did feel that the changes to our hiring process were helpful in reaching under-represented candidates, but there is still a tremendous amount of work for us to do around team diversity.

The first place where we want to experiment in the future is how we advertise our job openings.  We had tried advertising on a couple of different job boards in the past, and eventually pulled the trigger on a contract with Stack Overflow Careers.  This was an expensive option for us, since it required a year-long contract, and we weren’t entirely happy with the response we got. While we did get lots of good candidate responses, we also got a lot of noise.  Most importantly, we didn’t see many responses from under-represented candidates, especially at senior levels.  This wasn’t entirely a surprise, but going into 2020, we’ll probably use that money to focus on more specific advertising--perhaps by travelling to career fairs or conferences.
